...
const file_pkg_grpc_proto_agent_proto_rawDesc = "" +
	"\n" +
	"\x1apkg/grpc/proto/agent.proto\x12\x05agent\"\xd6\x01\n" +
	"\n" +
	"RunRequest\x12\x14\n" +
	...
	"\x0emax_iterations\x18\x04 \x01(\x05R\rmaxIterations\x1a:\n" +
	...
	"\acontext\x18\x02 \x03(\v2\x1f.agent.PlanRequest.ContextEntryR\acontext\x1a:\n" +
	"\fContextEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
...
func file_pkg_grpc_proto_agent_proto_rawDescGZIP() []byte {
	file_pkg_grpc_proto_agent_proto_rawDescOnce.Do(func() {
		// #nosec G103 - This is generated protobuf code that requires unsafe operations
